...
/**
 * Created by Gal on 28/10/2017.
 * TODO ADD LOADER, ADD Progress Bar, ADD no events to display, ADD Shared Preferences
 */
...
//            earthquakesList = extractEarthquakesFromJson(jsonResponse);
//
//        }
...
//            }
//            else{
//                Log.e(LOG_TAG,"Error Server Response Code: "+urlConnection.getResponseCode() );
//            }
//        }catch (IOException e) {
//            Log.e(LOG_TAG,"Error requesting URL: ", e);
//
//        }finally {
...
//                    inputStream.close();
//                } catch (IOException e) {
//                    Log.e(LOG_TAG,"Error Closing inputStream while requesting JsonResponse: ", e);
//
//                }
//            }
//
...
//                JSONObject eqproperties = feature.getJSONObject("properties");
//                double magnitude = eqproperties.getDouble("mag");
//                String place = eqproperties.optString("place");
//                long time = eqproperties.optLong("time");
//                String url = eqproperties.getString("url");
